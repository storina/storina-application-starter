...
class JDate {
    ...
    public static function gregorian_to_timestamp($string){
        $jalali_array = explode("/", $string);
        $gregorian_string = self::jalali_to_gregorian(current($jalali_array), next($jalali_array), next($jalali_array),"-");
        return strtotime($gregorian_string);
    }
