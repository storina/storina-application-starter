...
$info = array(
	...
	'title'       => esc_html__( "Scroll Banners ads", 'storina-application' ) . '<span style="display: none;"> #' . $elementID[ $i ] . '</span>',
);
global $pages;
if ( $pages ) {
...
$options = array(
	'type'               => 'custom',
	'title'              => esc_html__( "Select the banners for show in home page", 'storina-application' ),
