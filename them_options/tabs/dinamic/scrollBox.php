...
$info = array(
	...
	'title'       => esc_html__( "Scroll Box", 'storina-application' ) . '<span style="display: none;"> #' . $elementID[ $i ] . '</span>',
);
global $pages;
if ( $pages ) {
...
$options = array(
	'type'               => 'custom4',
	'title'              => esc_html__( "Scrolled box with title and icon and link", 'storina-application' ),
