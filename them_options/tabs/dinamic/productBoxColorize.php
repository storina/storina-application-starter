...
$info=array(
	...
	'title'       => esc_html__( "Product box colorize", 'onlinerShopApp' ) . '<span style="display: none;"> #' . $elementID[ $i ] . '</span>',
);
global $pages;
if($pages){
...
$options=array(
    ...
    array(
        'type' => 'color',
        'name' => esc_html__("Background color","onlinerShopApp"),
        'id' => "boxColor".$elementID[$i],
        'desc' => esc_html__("Background color of product box","onlinerShopApp")
    ),
    array(
        'type' => 'picture',
        'name' => esc_html__("icon","onlinerShopApp"),
        'id' => "boxIcon".$elementID[$i],
        'desc' => esc_html__("icon that will be shown on the right","onlinerShopApp"),
    ),
    array(
        'type' => 'picture',
        'name' => esc_html__("background image","onlinerShopApp"),
        'id' => "boxBackgroundImage".$elementID[$i],
        'desc' => esc_html__("Background image will be shown all over the box","onlinerShopApp"),
    ),
    array(
        "type" => "text",
