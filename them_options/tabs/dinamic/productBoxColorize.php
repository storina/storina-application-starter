...
$info=array(
	...
	'title'       => __( "Product box colorize", 'onlinerShopApp' ) . '<span style="display: none;"> #' . $elementID[ $i ] . '</span>',
);
global $pages;
if($pages){
...
$options=array(
    ...
    array(
        'type' => 'color',
        'name' => __("Background color","onlinerShopApp"),
        'id' => "boxColor".$elementID[$i],
        'desc' => __("Background color of product box","onlinerShopApp")
    ),
    array(
        'type' => 'picture',
        'name' => __("icon","onlinerShopApp"),
        'id' => "boxIcon".$elementID[$i],
        'desc' => __("icon that will be shown on the right","onlinerShopApp"),
    ),
    array(
        'type' => 'picture',
        'name' => __("background image","onlinerShopApp"),
        'id' => "boxBackgroundImage".$elementID[$i],
        'desc' => __("Background image will be shown all over the box","onlinerShopApp"),
    ),
    array(
        "type" => "text",
