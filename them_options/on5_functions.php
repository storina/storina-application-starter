...
function storina_delete_cache_dashboard() { ?>
	 <form action="" method="POST" style="display: inline;">
        <input class="button" type="submit" name="delede_cache" value="<?php echo__("Delete cache","onlinerShopApp");?>"/>
    </form>
    <p><br/><?php echo__("You can delete application cache from this box.","onlinerShopApp");?></p>
<?php
}
function storina_delete_cache_notice() {
	?>
    <div class="updated">
        <p><?php echo__("Deleted application cache","onlinerShopApp");?></p>
    </div>
	<?php
}
