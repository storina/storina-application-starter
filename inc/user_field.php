...
<h3><?php echo__('Extra information','onlinerShopApp')?></h3>
<table class="form-table">

    <tr>
        <th><label for="userToken"><?php echo__('User token','onlinerShopApp')?></label></th>
        ...
        <td>
            ...
            <span class="description"><?php echo__('Current user token id.','onlinerShopApp');?></span>
        </td>
    </tr>

    <tr>
        <th><label for="gender"><?php echo__('Gender','onlinerShopApp');?></label></th>
        ...
        <td>
            ...
            <br />
            <span class="description"><?php echo__('Select your gender','onlinerShopApp');?></span>
        </td>
    </tr>
    <tr>
        <th><label for="melliCode"><?php echo__('National codeٔ','onlinerShopApp');?></label></th>
        ...
        <td>
            ...
            <span class="description"><?php echo__('National codeٔ','onlinerShopApp');?></span>
        </td>
    </tr>
    <tr>
        <th><label for="birthDate"><?php echo__('Birth date','onlinerShopApp');?></label></th>
        <?php
        ...
        <td>
            ...
            <span class="description"><?php echo__('Birth date','onlinerShopApp');?></span>
        </td>
    </tr>
...
add_action('dokan_order_detail_after_order_items', function ($order){
    ...
    <script>
        $(document).ready(function(){
            ...
            mobile1 = '<li><a href="#">' + <?php echo__('Mobile 1 :','onlinerShopApp');?> + ' <span class="tab"><?php echo $billing_mobile; ?></span></a></li>';
			<?php }
			if(!empty($shipping_mobile)){
			?>
            mobile2 = '<li><a href="#">' + <?php echo__('Mobile 2 :','onlinerShopApp');?> +'<span class="tab"><?php echo $shipping_mobile; ?></span></a></li>';
			<?php } 
			$timestamp = get_post_meta( $order->id, 'time4SendTimestamp', true );
			$valid_timestamp = (strlen($timestamp) > 10)? intval($timestamp/1000) : $timestamp;
			$date = (is_rtl())? STORINA\Libraries\JDate::jdate("Y-m-d H:i",$valid_timestamp) : date("Y-m-d H:i",$valid_timestamp);
			if(!empty($timestamp)){
			?>
            timestamp = '<li><a href="#">' + <?php echo__('Send box time and date :','onlinerShopApp');?> + '<span class="tab"><?php echo $date; ?></span></a></li>';
			<?php } ?>
